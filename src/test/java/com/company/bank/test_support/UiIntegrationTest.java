package com.company.bank.test_support;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.bank.screen")
@ContextConfiguration(classes = {BankApplication.class, UiTestAssistConfiguration.class})
